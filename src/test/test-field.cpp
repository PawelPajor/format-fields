...
TEST_CASE("Top Level", "[lib]") {
  ...
  SECTION("Horizontal") {
    auto out = std::stringstream();
    auto err = std::stringstream();
    const auto presenter = presenter_t(bitset_t(tested_value), fields, enum_names, presentation_style::horizontal, err);
    out << presenter;
  ...
  SECTION("Vertical") {
    auto out = std::stringstream();
    auto err = std::stringstream();
    const auto presenter = presenter_t(bitset_t(tested_value), fields, enum_names, presentation_style::vertical, err);
    out << presenter;
